  ...
  return (
    ...
    <div class="row" >
      ...
      <h2><b>Together We Can!</b></h2>
               ...
               <div> </div> 
                 <div >Many a times it is observed that many complaints/queries raised by people are and ounot been addressed instantly. So <i><q>Communal Help Desk</q></i>will provides facility for reporting online issues related to public services, general and unethical issues which can be addressed and resolved by instantly. </div>
                ...
                <div>So  <i>TechAid</i> is a resource intended to provide the customer or end user with relevant information asked or to resolve the complaints registered by them. Also you can drop in your valuable suggestion so that we can work on them as well. Our team is actively working to resolve customer complaints.  </div>
