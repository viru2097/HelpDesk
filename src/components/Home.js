    ...
    <div className="container-fluid">
      <Carousel>
            ...
            <p>
              <b>
                <span style={{ fontSize: 30 }}>
                  See how help desk can simplify your customer support.
                </span>
              </b>
            </p>
          </Carousel.Caption>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption style={{ color: "black" }}>
            ...
            <p>
              <b style={{ fontSize: 30 }}>Servicing on Voice is a new Skill</b>
            </p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption style={{ color: "black" }}>
            ...
            <p>
              <b style={{ fontSize: 30 }}>Handling tough Tasks through Voice</b>
            </p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
      <div className="container">
        <Commons
          ...
          imgsrc={web1}
          style={{ margintop: "-250px", width: "350px", height: "450px" }}
          visit="/Home"
          btname="Contact now"
        ></Commons>
      </div>
      <div class="container-fluid mx-auto ">
        <div class="row justify-content-center top-part">
          <div class="col-md-6 text-center center-content">
            ...
            <div class="d-flex-inline">
              <p>
                Help desk has a point of contact for customers to send their
                queries and a ticketing system that tracks and organizes issues
            ...
            <a href="./Complains">
              <div class="d-flex-inline pt-2">
                {" "}
                <button class="btn-pink btn">Register complaint</button>{" "}
              </div>
            </a>
          </div>
        </div>
