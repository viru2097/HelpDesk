...
function Register  ()  {
  ...
  const registerUser = (e) => {
    ...
    else if (!aadharRegex.test(user.aadharCard) || user.aadharCard.length<12){
            ...
            <div class="card card-4 ">
                        ...
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input class="input--style-4" value={user.firstName} type="text" name="firstName" 
              onChange={(e) => setUser({ ...user, firstName: e.target.value })}/>
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" value={user.lastName} name="lastName" 
              onChange={(e) => setUser({ ...user, lastName: e.target.value })}/>
                        ...
                        <div class="row row-space">
                            <div class="col-12">
                                <div class="input-group">
                                   ...
                                   <textarea class="input--style-4 border border-white"  cols="50"  value={user.address} style={{height: '100px'}} onChange={(e) => setUser({ ...user, address: e.target.value })} ></textarea></div>
                        ...
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" value={user.emailId} type="email" name="emailId" 
                           onChange={(e) => setUser({ ...user, emailId: e.target.value })}/>
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="mobileNo" value={user.mobileNo} 
                        ...
                        <div class=" col-6 input-group">
                            <label class="label">Select UID Type</label>
                            
                            <div class="rs-select2 js-select-simple select--no-search">
                                  <select class="custom-select custom-select-lg  input--style-4"style={{width:'100%'}}>
                        ...
                        <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" value={user.aadharCard} type="text" name="aadharCard"  
                            onChange={(e) => setUser({ ...user, aadharCard: e.target.value })}/>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" value={user.userName} name="userName"
                           ...
                           onChange={(e) => setUser({ ...user, password: e.target.value })}/>
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="confirmPassword" value={user.confirmPassword} onChange={(e)=> setUser({...user,confirmPassword:e.target.value})}/>
                                </div>
                            </div>
