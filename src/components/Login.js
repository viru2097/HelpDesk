...
function Login() {
  ...
  const adminlogin= useCallback((data)=>{
    axios.post(`http://localhost:8080/exHead/login`,data).then(
      (response)=>{
  ...
  return (
    <div class="col-8 offset-2 mt-3 text-light d-flex flex-column justify-content-center align-items-center">
			<div class=" card w-50 card border-info bg-info" style={{width: '50rem'}}>
  ...
  <option disabled="disabled" selected>Open this select menu </option>
  <option >User</option>
  <option >Admin</option>
</select>
</div>
